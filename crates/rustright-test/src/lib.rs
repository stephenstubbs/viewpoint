//! Test framework for `RustRight` browser automation.
//!
...
//!
//! ```no_run
//! use rustright_test::TestHarness;
//!
//! #[tokio::test]
...
pub use rustright_test_macros::test;

// Re-export core types for convenience
pub use rustright_core::{Browser, BrowserContext, CoreError, DocumentLoadState, Page};
