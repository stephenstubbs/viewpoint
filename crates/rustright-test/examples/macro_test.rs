//! Example: Test with `#[rustright::test]` Macro
//!
...
use rustright_test::{expect_page, TestError, TestHarness};
use rustright_core::DocumentLoadState;

/// Example of what the macro expands to.
/// 
/// The `#[rustright_test::test]` macro would transform:
/// ```ignore
/// #[rustright_test::test]
...
/// ```ignore
/// #[rustright_test::test(headless = false, timeout = 60000)]
...
/// }
/// 
/// #[rustright_test::test(scope = "browser", browser = "shared_browser")]
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("=== RustRight Macro Example ===\n");
    
    println!("This example demonstrates the #[rustright_test::test] macro.\n");
