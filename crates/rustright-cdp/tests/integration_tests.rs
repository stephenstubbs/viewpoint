//! Integration tests for rustright-cdp.
//!
...
use rustright_cdp::protocol::target::{GetTargetsParams, GetTargetsResult};
...
async fn test_cdp_session_commands() {
    ...
    let create_result: rustright_cdp::protocol::target::CreateBrowserContextResult = conn
        .send_command(
            "Target.createBrowserContext",
            Some(rustright_cdp::protocol::target::CreateBrowserContextParams::default()),
            None,
        )
        .await
    ...
    let target_result: rustright_cdp::protocol::target::CreateTargetResult = conn
        .send_command(
            "Target.createTarget",
            Some(rustright_cdp::protocol::target::CreateTargetParams {
    ...
    let attach_result: rustright_cdp::protocol::target::AttachToTargetResult = conn
        .send_command(
            "Target.attachToTarget",
            Some(rustright_cdp::protocol::target::AttachToTargetParams {
    ...
    // Navigate the page
    let nav_result: rustright_cdp::protocol::page::NavigateResult = conn
        .send_command(
            "Page.navigate",
            Some(rustright_cdp::protocol::page::NavigateParams {
...
async fn test_cdp_event_subscription() {
    ...
    conn.send_command::<_, rustright_cdp::protocol::page::NavigateResult>(
        "Page.navigate",
        Some(rustright_cdp::protocol::page::NavigateParams {
            url: "https://example.com".to_string(),
            referrer: None,
