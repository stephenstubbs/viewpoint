...
use rustright_cdp::protocol::target::{CreateBrowserContextParams, CreateBrowserContextResult};
...
impl Browser {
    ...
    ///
    /// ```no_run
    /// use rustright_core::Browser;
    ///
    /// # async fn example() -> Result<(), rustright_core::CoreError> {
