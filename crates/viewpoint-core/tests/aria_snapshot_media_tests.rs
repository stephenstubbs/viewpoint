...
async fn test_aria_snapshot_svg() {
    ...
    assert!(
        yaml.contains("img"),
        "Snapshot should contain 'img' role for svg, got: {}",
        yaml
    );
    assert!(
        yaml.contains("Circle graphic"),
        "Snapshot should contain svg aria-label, got: {}",
        yaml
    );
...
async fn test_aria_snapshot_area_with_href() {
    ...
    assert!(
        yaml.contains("link"),
        "Snapshot should contain 'link' role for area with href, got: {}",
        yaml
    );
...
async fn test_aria_snapshot_hr() {
    ...
    assert!(
        ...
        "Snapshot should contain 'separator' role for hr, got: {}",
        yaml
    );
...
async fn test_aria_snapshot_hr_with_aria_label() {
    ...
    assert!(
        yaml.contains("separator"),
        "Snapshot should contain 'separator' role, got: {}",
        yaml
    );
    assert!(
        yaml.contains("Content divider"),
        "Snapshot should contain hr aria-label, got: {}",
        yaml
    );
...
async fn test_aria_snapshot_menu() {
    ...
    assert!(
        yaml.contains("list"),
        "Snapshot should contain 'list' role for menu, got: {}",
        yaml
    );
    assert!(
        yaml.contains("listitem"),
        "Snapshot should contain 'listitem' for menu items, got: {}",
        yaml
    );
...
async fn test_aria_snapshot_math() {
    ...
    assert!(
        yaml.contains("math"),
        "Snapshot should contain 'math' role, got: {}",
        yaml
    );
    assert!(
        yaml.contains("Quadratic formula"),
        "Snapshot should contain math aria-label, got: {}",
        yaml
    );
