//! Set input files from memory buffers.
...
impl Locator<'_> {
    ...
    pub async fn set_input_files_from_buffer(
        ...
        if let Selector::Ref(ref_str) = &self.selector {
            ...
            return self
                .set_input_files_from_buffer_by_backend_id(backend_node_id, files)
                .await;
        }
    ...
    pub(super) async fn set_input_files_from_buffer_by_backend_id(
        &self,
        ...
        let js_fn_buffer = js_fn_buffer.trim_start_matches('(').trim_end_matches(')');
        ...
        let call_result: CallResult = self
            ...
            .send_command(
                ...
                Some(serde_json::json!({
                    "objectId": object_id,
                    "functionDeclaration": js_fn_buffer,
                    "returnByValue": true
                })),
                Some(self.page.session_id()),
            )
